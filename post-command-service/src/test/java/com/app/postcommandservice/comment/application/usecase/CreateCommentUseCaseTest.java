...
class CreateCommentUseCaseTest {
    ...
    private Post postWithStatus(UUID ownerId, PostStatus status) {
        ...
        return new Post(
                ...
                new UserId(ownerId),
                null,
                new com.app.postcommandservice.post.domain.model.PostInfo(null, new PostDescription("post"),
                        new PostTaggedUsers(java.util.Set.of()), new PostTags(java.util.Set.of()), PostType.BASIC),
