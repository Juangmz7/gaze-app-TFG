...
class CollabDeletedEventPublisherTest {
    ...
    @InjectMocks
    private CollabDeletedEventPublisher publisher;

    @Test
    void shouldPublishCollabDeletedEventToRabbitMqUsingConfiguredRoutingKey() {
        var payload = CollabDeletedEvent.builder()
                .id(UUID.randomUUID())
