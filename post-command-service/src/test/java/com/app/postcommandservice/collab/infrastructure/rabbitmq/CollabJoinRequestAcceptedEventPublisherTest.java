...
class CollabJoinRequestAcceptedEventPublisherTest {
    ...
    @InjectMocks
    private CollabJoinRequestAcceptedEventPublisher publisher;

    @Test
    void shouldPublishCollabJoinRequestAcceptedEventToRabbitMqUsingConfiguredRoutingKey() {
        var payload = CollabJoinRequestAcceptedEvent.builder()
                .id(UUID.randomUUID())
                .correlationId(UUID.randomUUID())
                .occurredAt(Instant.now())
                .collabId(UUID.randomUUID())
                .userId(UUID.randomUUID())
                .acceptedBy(UUID.randomUUID())
