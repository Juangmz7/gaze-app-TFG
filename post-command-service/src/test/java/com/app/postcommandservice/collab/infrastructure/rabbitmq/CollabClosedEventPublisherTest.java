...
class CollabClosedEventPublisherTest {
    ...
    @InjectMocks
    private CollabClosedEventPublisher publisher;

    @Test
    void shouldPublishCollabClosedEventToRabbitMqUsingConfiguredRoutingKey() {
        var payload = CollabClosedEvent.builder()
                .id(UUID.randomUUID())
