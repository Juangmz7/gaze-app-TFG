...
class DeletePostUseCaseTest {
    ...
    private Post persistedPost(UUID ownerId, PostStatus status) {
        ...
        return new Post(
                ...
                new UserId(ownerId),
                null,
                new com.app.postcommandservice.post.domain.model.PostInfo(null, new PostDescription("description"),
                        new PostTaggedUsers(new LinkedHashSet<>(Set.of("alice"))), new PostTags(new LinkedHashSet<>(Set.of("java"))), PostType.BASIC),
