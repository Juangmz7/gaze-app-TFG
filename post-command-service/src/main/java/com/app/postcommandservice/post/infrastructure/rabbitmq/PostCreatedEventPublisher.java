...
public class PostCreatedEventPublisher implements EventPublisher {
    ...
    public boolean supports(String eventType) {
        return PostCreatedEvent.class.getSimpleName().equals(eventType);
    }

    @Override
    public void publish(OutboxEvent outboxEvent) {
        var event = jsonMapper.fromJson(outboxEvent.getPayload(), PostCreatedEvent.class);
        rabbitTemplate.convertAndSend(
                rabbitMQProperties.getExchange().getPost().getEvents(),
                rabbitMQProperties.getRk().getPost().getCreated(),
                event
        );
    }
}
