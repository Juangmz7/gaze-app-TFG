...
public class PostLikeDeletedEventPublisher implements EventPublisher {
    ...
    public boolean supports(String eventType) {
        return PostLikeDeletedEvent.class.getSimpleName().equals(eventType);
    }

    @Override
    public void publish(OutboxEvent outboxEvent) {
        var event = jsonMapper.fromJson(outboxEvent.getPayload(), PostLikeDeletedEvent.class);
