...
public class CollabJoinRequestCreatedEventPublisher implements EventPublisher {
    ...
    public boolean supports(String eventType) {
        return CollabJoinRequestCreatedEvent.class.getSimpleName().equals(eventType);
    }

    @Override
    public void publish(OutboxEvent outboxEvent) {
        var event = jsonMapper.fromJson(outboxEvent.getPayload(), CollabJoinRequestCreatedEvent.class);
