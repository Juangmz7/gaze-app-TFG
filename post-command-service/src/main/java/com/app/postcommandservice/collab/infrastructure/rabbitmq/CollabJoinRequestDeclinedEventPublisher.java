...
public class CollabJoinRequestDeclinedEventPublisher implements EventPublisher {
    ...
    public boolean supports(String eventType) {
        return CollabJoinRequestDeclinedEvent.class.getSimpleName().equals(eventType);
    }

    @Override
    public void publish(OutboxEvent outboxEvent) {
        var event = jsonMapper.fromJson(outboxEvent.getPayload(), CollabJoinRequestDeclinedEvent.class);
