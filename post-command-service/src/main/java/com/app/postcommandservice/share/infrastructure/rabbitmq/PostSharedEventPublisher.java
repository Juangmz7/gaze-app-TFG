...
public class PostSharedEventPublisher implements EventPublisher {
    ...
    public boolean supports(String eventType) {
        return PostSharedEvent.class.getSimpleName().equals(eventType);
    }

    @Override
    public void publish(OutboxEvent outboxEvent) {
        var event = jsonMapper.fromJson(outboxEvent.getPayload(), PostSharedEvent.class);
