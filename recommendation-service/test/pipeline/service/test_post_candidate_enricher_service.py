...
def test_enrich_fetches_post_features_and_post_interaction_features(
...
def test_enrich_fetches_creator_and_tag_features_based_on_post_data(
    enricher,
    post_features_repo,
    post_interaction_features_repo,
    user_creator_features_repo,
...
def test_enrich_maps_raw_and_decayed_interaction_stats(
    enricher,
    post_features_repo,
    post_interaction_features_repo
):
...
def test_enrich_maps_creator_and_tag_affinities(
    enricher,
    post_features_repo,
    post_interaction_features_repo,
    user_creator_features_repo,
